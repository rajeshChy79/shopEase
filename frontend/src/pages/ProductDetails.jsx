...
>
  <Heart className={`w-5 h-5 ${isWishlisted ? "fill-current" : ""}`} />
                ...
                <button
                  onClick={handleShare}
                  className="flex items-center space-x-1 px-3 py-1 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-50 transition"
                >
            ...
            <div className="flex space-x-4">
              {!isInCart ? (
                ...
                <button
                  onClick={handleRemove}
                  className="flex-1 bg-red-600 hover:bg-red-700 text-white py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2"
                >
